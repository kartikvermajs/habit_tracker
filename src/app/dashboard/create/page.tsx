  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fafbfc]">
      ...
      <header className="flex items-center px-5 pt-12 pb-5 sticky top-0 bg-[#fafbfc]/90 backdrop-blur-md z-10">
        ...
        >
          <ArrowLeft className="cursor-pointer w-5 h-5 text-[#1e293b]" />
        </button>
      ...
      <div className="flex flex-col gap-6 px-5 pb-12">
        ...
        <button
          onClick={() => setSelected({})}
          className="cursor-pointer flex items-center justify-between w-full bg-gradient-to-br from-[#8b5cf6] to-[#6d28d9] text-white p-5 rounded-3xl shadow-[0_8px_20px_rgba(109,40,217,0.3)] active:scale-[0.98] transition-all"
        >
        ...
        <div className="flex flex-col gap-3">
          {PREDEFINED_HABITS.map(habit => (
            <button
              ...
              className="cursor-pointer flex items-center gap-4 w-full bg-white p-4 rounded-2xl shadow-[3px_3px_12px_rgba(0,0,0,0.06),-3px_-3px_8px_rgba(255,255,255,0.9)] active:shadow-[inset_2px_2px_6px_rgba(0,0,0,0.06)] transition-all"
            >
              {/* Color dot with icon */}
              <div
